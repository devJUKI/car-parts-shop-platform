...
{
    public record CarDto(int Id, DateTime FirstRegistration, int Mileage, float Engine, int Power, string Body, string Fuel, string Gearbox, string Model, ShopDto Shop, string Make = "");
